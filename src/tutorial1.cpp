...
int main(int argc, char** argv)
{
  ...
  spinner.start();
  moveit::planning_interface::MoveGroupInterface group("sia5_ft");
  ...
  */
  ...
  {
    Eigen::Affine3d pose;
    pose = Eigen::Translation3d(0.0, 0.5, 0.5 - 0.09 * i);
    Eigen::Quaterniond quat;
    double rotationRadians = 3.14195/2;
    Eigen::Vector3d rotationVector = Eigen::Vector3d(0,0,1);
    quat = Eigen::AngleAxisd(rotationRadians, rotationVector);
  ...
  {
    Eigen::Affine3d pose;
    pose = Eigen::Translation3d(0.0 - 0.09 * i, 0.5, 0.32);
    Eigen::Quaterniond quat;
    double rotationRadians = 3.14195/2;
    Eigen::Vector3d rotationVector = Eigen::Vector3d(0,0,1);
    quat = Eigen::AngleAxisd(rotationRadians, rotationVector);
  ...
  {
    Eigen::Affine3d pose;
    pose = Eigen::Translation3d(-0.18, 0.5, 0.32 + 0.09 * i);
    Eigen::Quaterniond quat;
    double rotationRadians = 3.14195/2;
    Eigen::Vector3d rotationVector = Eigen::Vector3d(0,0,1);
    quat = Eigen::AngleAxisd(rotationRadians, rotationVector);
  ...
  {
    Eigen::Affine3d pose;
    pose = Eigen::Translation3d(-0.18 + 0.09 * i, 0.5, 0.5);
    Eigen::Quaterniond quat;
    double rotationRadians = 3.14195/2;
    Eigen::Vector3d rotationVector = Eigen::Vector3d(0,0,1);
    quat = Eigen::AngleAxisd(rotationRadians, rotationVector);
